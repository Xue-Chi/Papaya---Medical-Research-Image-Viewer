...
// goto timepoint you need modified
papaya.viewer.ScreenVolume.prototype.gotoTimepoint = function (timepoint) {
    this.currentTimepoint = timepoint
    if (this.currentTimepoint < 0) {
        this.currentTimepoint = 0;
    }
    if(this.currentTimepoint >= this.volume.numTimepoints){
        this.currentTimepoint = this.volume.numTimepoints - 1
    }
    window.viewerThis.timepointChanged();
};
