...
2. Choose an editor of your choice (VSCode recommended) and open the folder Papaya.
3. Find the file named debug_local.html and choose a browser (Google Chrome
recommended) of your choice to run the file. 
4. Close the default image and load the test image.
